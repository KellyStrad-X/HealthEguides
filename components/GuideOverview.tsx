...
export default function GuideOverview({ guide }: GuideOverviewProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0a] to-[#1a1a2e] py-20">
      <div className="section-container">
        <div className="max-w-4xl mx-auto">
          {/* Hero Section */}
          <div className="text-center mb-12">
            <div className="text-8xl mb-6">{guide.emoji}</div>
            ...
            <button
              ...
              className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white text-lg font-semibold rounded-full shadow-2xl hover:scale-105 transition-all duration-300"
            >
              Start Reading
